...
@section('title','練習')
@section('content')
<p class="message">以下のような3種類の音がC4~B6の範囲で自動的に再生されます。</p>
<h3>純音</h3>
...
<p class="message">以下の鍵盤で回答を行います。鍵盤を押すと押した鍵盤の色が変わります。</p>
<div>
...
<p class="message">3回ほど練習してみましょう。<br>音は一度だけ鳴ります。回答時間は10秒間です。鍵盤を押して2秒経過するか、回答せず10秒経過すると次の問題へ移動します。<br>

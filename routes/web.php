...
Route::get('labolatory', [EnqueteController::class, 'labolatory']);

Route::get('link', [EnqueteController::class, 'link']);

Route::get('privacypolicy', [EnqueteController::class, 'privacypolicy']);

Route::get('tame', [EnqueteController::class, 'tame']);
...
Route::get('test_mail_send1', [EnqueteController::class, 'test_mail_send1']);

Route::get('test_mail_send2', [EnqueteController::class, 'test_mail_send2']);

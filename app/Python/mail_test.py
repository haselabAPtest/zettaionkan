...
with open(r'D:\xampp\htdocs\piano_demo\app\Python\time.txt',W) as f:
...
def create_message(sender,to,subject,message_text,cc=None):
    ...
    with open(PATH+'sample.png','rb') as img:
        atchment_file=MIMEImage(img.read(),_subtype='png')
    
    atchment_file.set_param('name','sample.png')
    atchment_file.add_header('Content-ID','<sample_image>')

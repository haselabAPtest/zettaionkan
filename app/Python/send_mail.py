...
ADDRESS='aisawa.y@sound.is.utsunomiya-u.ac.jp'
HOST='127.0.0.1'
PORT=3306
USER='root'
PASSWORD='APtest'
DATABASE='zettaionkan2021'
...
proxies_dic = {
  ...
  "https": "http://proxy.cc.utsunomiya-u.ac.jp:8080",
}
r = requests.get("https://www.googleapis.com/oauth2/v1/certs", proxies=proxies_dic)
print(r.status_code)
...
def main():
    ...
    #メール本文作成
    sender='ap-test@sound.is.utsunomiya-u.ac.jp '
    to=mail
